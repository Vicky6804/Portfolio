      ...
      <header className="sticky top-0 z-50 w-full bg-neutral-950/75 backdrop-blur-md border-b border-neutral-900/80 px-4 md:px-8 py-3.5 flex justify-between items-center">
        <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[9px] text-neutral-500 font-medium tracking-wider font-mono mt-0.5">FRONTEND DEV</span>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 md:px-8 pt-12 md:pt-16 pb-12">
          ...
          <div className="lg:col-span-4 bg-neutral-900/40 backdrop-blur-md border border-neutral-800/60 rounded-2xl p-5 space-y-4 shadow-xl">
            ...
            <div className="border-t border-neutral-950/80 pt-3 space-y-2.5 text-xs text-neutral-400">
              <div className="flex justify-between">
                <span className="text-neutral-500 font-medium">B.Tech Graduation</span>
                <span className="font-semibold text-neutral-200">2026</span>
              </div>
              <div className="flex justify-between">
                <span className="text-neutral-500 font-medium">Total Web Apps built</span>
                <span className="font-semibold text-neutral-200">3 Live Apps</span>
              </div>
              <div className="flex justify-between">
                <span className="text-neutral-500 font-medium">Work internship</span>
                <span className="font-semibold text-neutral-200">1 Fullstack Intern</span>
              </div>
            </div>
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-3 bg-neutral-900/30 border border-neutral-900/60 p-4 rounded-2xl">
          <div className="text-center p-2.5">
            ...
            <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-wider mt-0.5">Live Websites</p>
          </div>
          <div className="text-center p-2.5">
            <Code2 className="w-5 h-5 text-neutral-500 mx-auto mb-1.5" />
            <p className="text-lg font-extrabold text-neutral-100">15+</p>
            <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-wider mt-0.5">Core Modules</p>
          </div>
          <div className="text-center p-2.5">
            <Database className="w-5 h-5 text-neutral-500 mx-auto mb-1.5" />
            <p className="text-lg font-extrabold text-neutral-100">MySQL & Firebase</p>
            <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-wider mt-0.5">Dual DB Synced</p>
          </div>
          <div className="text-center p-2.5">
            <Shield className="w-5 h-5 text-neutral-500 mx-auto mb-1.5" />
            <p className="text-lg font-extrabold text-neutral-100">100% Secure</p>
            <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-wider mt-0.5">Server Guarded API Keys</p>
          </div>
        </div>
      </section>
