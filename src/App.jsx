...
import { 
  Github, Mail, Phone, MapPin, Copy, Check, Sparkles, 
  ArrowUpRight, Download, Laptop, Code2, Database, Shield, BookOpen 
} from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-neutral-950 text-neutral-100 selection:bg-neutral-800 selection:text-white font-sans overflow-x-hidden pb-12">
      ...
      <header className="sticky top-0 z-50 w-full bg-neutral-950/75 backdrop-blur-md border-b border-neutral-900/80 px-4 md:px-8 py-3.5 flex justify-between items-center">
        <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          ...
          <div className="flex flex-col">
            <span className="font-bold text-xs tracking-tight text-neutral-100 leading-none">{personalInfo.name}</span>
            <span className="text-[9px] text-neutral-500 font-medium tracking-wider font-mono mt-0.5">Developer</span>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 md:px-8 pt-12 md:pt-16 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-4">
            <span className="inline-flex items-center gap-1.5 bg-neutral-900 border border-neutral-800 px-3 py-1 rounded-full text-[10px] text-neutral-400 font-mono tracking-wider">
              <Sparkles className="w-3.5 h-3.5 text-neutral-300 animate-pulse" /> OPEN TO NEW ROLES
            </span>
            ...
            <div className="flex flex-wrap gap-2.5 pt-2">
              ...
              >
                ...
                <span className="text-neutral-300 truncate max-w-[180px]">{personalInfo.email}</span>
                {copiedType === 'email' ? (
              ...
              >
                ...
                <span className="text-neutral-300 font-mono">{personalInfo.phone}</span>
                {copiedType === 'phone' ? (
                  <Check className="w-3.5 h-3.5 text-emerald-500 shrink-0" />
                ) : (
                  <Copy className="w-3.5 h-3.5 text-neutral-600 opacity-0 group-hover:opacity-100 transition-opacity shrink-0" />
          ...
          <div className="lg:col-span-4 bg-neutral-900/40 backdrop-blur-md border border-neutral-800/60 rounded-2xl p-5 space-y-4 shadow-xl">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <h3 className="font-bold text-sm text-neutral-100">{personalInfo.name}</h3>
                <p className="text-[10px] text-neutral-500 uppercase tracking-widest font-mono font-bold">{personalInfo.title}</p>
              </div>
            </div>

            <div className="border-t border-neutral-950/80 pt-3 space-y-2.5 text-xs text-neutral-400">
              <div className="flex justify-between">
                <span className="text-neutral-500 font-medium">B.Tech (AI & Data Science)</span>
                <span className="font-semibold text-neutral-200">2026 Batch</span>
              </div>
              <div className="flex justify-between">
                <span className="text-neutral-500 font-medium">Core Engineering Projects</span>
                <span className="font-semibold text-neutral-200">5 Featured Systems</span>
              </div>
              <div className="flex justify-between">
                <span className="text-neutral-500 font-medium">Industry Internships</span>
                <span className="font-semibold text-neutral-200">2 (Full Stack & AI)</span>
              </div>
            </div>
            ...
            <a 
              href="#connect"
              onClick={(e) => { e.preventDefault(); handleScrollTo('connect'); }}
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-3 bg-neutral-900/30 border border-neutral-900/60 p-4 rounded-2xl">
          <div className="text-center p-2.5">
            ...
            <p className="text-lg font-extrabold text-neutral-100">5</p>
            <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-wider mt-0.5">Featured Systems</p>
          </div>
          <div className="text-center p-2.5">
            <Code2 className="w-5 h-5 text-neutral-500 mx-auto mb-1.5" />
            <p className="text-lg font-extrabold text-neutral-100">Python · React · Next</p>
            <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-wider mt-0.5">Core Languages & Tech</p>
          </div>
          <div className="text-center p-2.5">
            <Database className="w-5 h-5 text-neutral-500 mx-auto mb-1.5" />
            <p className="text-lg font-extrabold text-neutral-100">MySQL & FAISS</p>
            <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-wider mt-0.5">Relational & Vector DBs</p>
          </div>
          <div className="text-center p-2.5">
            <Shield className="w-5 h-5 text-neutral-500 mx-auto mb-1.5" />
            <p className="text-lg font-extrabold text-neutral-100">100% Tested</p>
            <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-wider mt-0.5">CV & RAG Validation</p>
          </div>
        </div>
      </section>

      {/* 5. PROJECTS SECTION */}
      <section id="projects" className="max-w-5xl mx-auto px-4 md:px-8 py-12 border-t border-neutral-900">
        <div className="mb-8 text-center md:text-left">
          ...
          <p className="text-neutral-400 text-xs mt-1.5 max-w-lg leading-relaxed">
            Highly engineered responsive web applications built with clean code practices, featuring direct external site redirections.
          </p>
        </div>
      ...
      {/* 6. SKILLS SECTION */}
      <section id="skills" className="max-w-5xl mx-auto px-4 md:px-8 py-12 border-t border-neutral-900">
        <div className="mb-8 text-center md:text-left">
          <span className="text-[10px] uppercase font-mono tracking-widest text-neutral-500 flex items-center justify-center md:justify-start gap-1">
          ...
          <p className="text-neutral-400 text-xs mt-1.5 max-w-lg leading-relaxed">
            Primary language frameworks, deployment environments, databases, and version controlling modules utilized in daily builds.
          </p>
        </div>
      ...
      {/* 7. TIMELINE SECTION */}
      <section id="experience" className="max-w-5xl mx-auto px-4 md:px-8 py-12 border-t border-neutral-900">
        <div className="mb-8 text-center md:text-left">
          <span className="text-[10px] uppercase font-mono tracking-widest text-neutral-500 flex items-center justify-center md:justify-start gap-1">
          ...
          <p className="text-neutral-400 text-xs mt-1.5 max-w-lg leading-relaxed">
            Timeline mapping both professional development internships and standard engineering studies chronologically.
          </p>
        </div>
      ...
      {/* 8. CONTACT SECTION */}
      <section id="connect" className="max-w-5xl mx-auto px-4 md:px-8 py-12 border-t border-neutral-900">
        <div className="mb-8 text-center md:text-left">
          <span className="text-[10px] uppercase font-mono tracking-widest text-neutral-500 flex items-center justify-center md:justify-start gap-1">
          ...
          <p className="text-neutral-400 text-xs mt-1.5 max-w-lg leading-relaxed">
            Submit a query to test live client-side telemetry logs. Your messages are stored in safety zones within your local browser.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-4 bg-neutral-900/40 backdrop-blur-md border border-neutral-800/60 rounded-2xl p-5 space-y-4 shadow-xl">
            ...
            <p className="text-xs text-neutral-400 leading-relaxed">
              Vignesh M is currently actively seeking Full-time Frontend Developer or Fullstack Intern opportunities. Ready to start instantly with full technical readiness.
            </p>
            ...
            <div className="border-t border-neutral-950/80 pt-4 space-y-3">
              <div className="flex gap-2.5 items-center text-xs text-neutral-300">
                ...
                <span>Notice Period: <strong className="text-neutral-100">Immediate (0 days)</strong></span>
              </div>
              <div className="flex gap-2.5 items-center text-xs text-neutral-300">
                <span className="w-1.5 h-1.5 bg-neutral-500 rounded-full" />
                <span>Willing to Relocate: <strong className="text-neutral-100">Yes</strong></span>
              </div>
              <div className="flex gap-2.5 items-center text-xs text-neutral-300">
                <span className="w-1.5 h-1.5 bg-neutral-500 rounded-full" />
                <span>Sponsorship Required: <strong className="text-neutral-100">No</strong></span>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="max-w-5xl mx-auto px-4 md:px-8 pt-8 mt-12 border-t border-neutral-900/80 flex flex-col sm:flex-row justify-between items-center gap-4 text-[10px] text-neutral-600 font-mono">
        <div>
          © 2026 {personalInfo.name}. All rights reserved locally.
        </div>
        <div>
          Coimbatore Division · Sri Ramakrishna Sprints
        </div>
      </footer>
    </div>
  );
